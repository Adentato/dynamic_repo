...
/**
 * Table Page under Dashboard/Workspace/Project
 *
...
export default async function TablePage({ params }: TablePageProps) {
  try {
    ...
    const { workspaceId, projectId, tableId } = await params
              ...
              <div className="mb-4">
                <Breadcrumb
                  items={[
                    ...
                    { label: organization?.name || 'Workspace', href: `/dashboard/workspace/${workspaceId}` },
                    { label: project.name, href: `/dashboard/workspace/${workspaceId}/project/${projectId}` },
                    { label: table.name },
                  ]}
                />
              </div>
